...
/***/ (function(module, exports, __webpack_require__) {
	...
	var URL = 'https://api.openweathermap.org/data/2.5/weather?units=imperial&appid=d014a001d630a649c9021d880ee403d0&q=';
	...
	module.exports = {
	    getTemp: function getTemp(location) {
	        ...
	        return axios.get(requstURL).then(function (res) {
